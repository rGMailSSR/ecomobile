...
const routes: TRoute[] = [
  { path: '/ecomobile/', name: 'Главная', icon: 'home' },
  { path: '/ecomobile/myNumbers', name: 'Мои номера', icon: 'data' },
  { path: '/ecomobile/services', name: 'Услуги', icon: 'office-bag' },
  { path: '/ecomobile/expenses', name: 'Расходы', icon: 'chart-pie' },
  { path: '/ecomobile/detailing', name: 'Детализация', icon: 'setting' },
  {
    path: '/ecomobile/remainingPackages',
    name: 'Остатки пакетов',
    icon: 'chart-col',
  },
  {
  ...
  { path: '/ecomobile/applications', name: 'Заявки', icon: 'message' },
  { path: '/ecomobile/profile', name: 'Профиль', icon: 'user' },
];
